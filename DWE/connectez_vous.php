...
//convert HTML into a basic plain-text alternative body
                        $mail->charSet = "UTF-8";
                        $mail->msgHTML('<p><strong>Bonjour ' . $pseudo . '</strong> <br><br> Pour modifier votre mot de passe veuillez cliquer ici : http://localhost:8888/github_DWE/DealWithEat/DWE/reinitialisationmdp.php?b='.$donnees['US_idUser'].'
