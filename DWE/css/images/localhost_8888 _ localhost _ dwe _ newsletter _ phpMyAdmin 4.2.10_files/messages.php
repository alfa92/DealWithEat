...
PMA_messages['strConfirmNavigation'] = "Êtes-vous sûr de vouloir quitter cette page ? Appuyez sur OK pour continuer ou sur Annuler pour rester sur la page en cours.";
...
PMA_messages['strFunctionHint'] = "Maj + clic sur le nom de la fonction à appliquer à toutes les lignes.";
...
PMA_messages['strMultiSortHint'] = "Maj + clic pour ajouter cette colonne à la clause ORDER BY ou pour basculer ASC/DESC.<br />- Ctrl + clic pour enlever la colonne de la clause ORDER BY";
